    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                "https://www.mercadobitcoin.net/api/BTC/day-summary/2019/1/1/",
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                "https://www.mercadobitcoin.net/api/TESTE/trades/1546300800/1546387200/",
            ),
            (
                "TESTE",
                datetime.datetime(2019, 1, 1),
                None,
                "https://www.mercadobitcoin.net/api/TESTE/trades/1546300800/",
            ),
...
class TestMercadoBitcoinApi:
    @patch("requests.get")
    @patch(
        "mercado_bitcoin.api.MercadoBitcoinApi._get_endpoint",
        return_value="valid_endpoint",
    )
    def test__requests_is_called(
    ...
    def test_get_data_with_valid_end_point(
        self, mock_get_endpoint, mock_requests, fixture_mercado_bitcoin_api
    ):
    ...
    def test_get_data_with_invalid_end_point(
        self, mock_get_endpoint, mock_requests, fixture_mercado_bitcoin_api
    ):
